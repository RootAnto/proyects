...
@author Antonio Llorente
@contact antoniollorentecuenca@gmail.com
@project Cebolla
"""
...
async def lifespan(app: FastAPI):
    ...
    # Required paths
    google_alerts_path = "src/data/google_alert_rss.txt"
    urls_path = "src/data/urls_cybersecurity_ot_it.txt"
